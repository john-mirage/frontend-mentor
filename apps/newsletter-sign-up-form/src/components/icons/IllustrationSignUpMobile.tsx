...
const SvgIllustrationSignUpMobile = (
  ...
  >
    <defs>
      <linearGradient
        id="illustration-sign-up-mobile_svg__b"
        x1="100%"
        x2="0%"
        y1="21.322%"
        y2="78.678%"
      ...
      <linearGradient
        id="illustration-sign-up-mobile_svg__h"
        x1="22.319%"
        x2="99.127%"
        y1="28.497%"
        y2="70.858%"
      ...
      <linearGradient
        id="illustration-sign-up-mobile_svg__k"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <linearGradient
        id="illustration-sign-up-mobile_svg__o"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <linearGradient
        id="illustration-sign-up-mobile_svg__p"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <linearGradient
        id="illustration-sign-up-mobile_svg__r"
        x1="97.791%"
        x2="7.729%"
        y1="26.944%"
        y2="71.879%"
      ...
      <linearGradient
        id="illustration-sign-up-mobile_svg__t"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <path
        id="illustration-sign-up-mobile_svg__a"
        d="M0 0v268c0 8.837 7.163 16 16 16h343c8.837 0 16-7.163 16-16V0H0Z"
      />
      <path
        id="illustration-sign-up-mobile_svg__e"
      ...
      />
      <path
        id="illustration-sign-up-mobile_svg__g"
      ...
      />
      <path
        id="illustration-sign-up-mobile_svg__i"
        d="M0 5.946A5.946 5.946 0 0 1 5.946 0H210.81a5.946 5.946 0 0 1 5.946 5.946v128.108A5.946 5.946 0 0 1 210.81 140H5.946A5.946 5.946 0 0 1 0 134.054V5.946Z"
      />
      <path
        id="illustration-sign-up-mobile_svg__n"
      ...
      />
      <path
        id="illustration-sign-up-mobile_svg__q"
      ...
      />
      <filter
        id="illustration-sign-up-mobile_svg__d"
        width="151.3%"
        height="176.8%"
        x="-25.6%"
        y="-23%"
      ...
      <filter
        id="illustration-sign-up-mobile_svg__f"
        width="155.4%"
        height="185.7%"
        x="-27.7%"
        y="-25.7%"
      ...
      <filter
        id="illustration-sign-up-mobile_svg__j"
        width="155.4%"
        height="185.7%"
        x="-27.7%"
        y="-25.7%"
      ...
      <filter
        id="illustration-sign-up-mobile_svg__m"
        width="151.3%"
        height="188.4%"
        x="-25.6%"
        y="-26.5%"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="illustration-sign-up-mobile_svg__c" fill="#fff">
        <use xlinkHref="#illustration-sign-up-mobile_svg__a" />
      </mask>
      <path d="M0 0v268c0 8.837 7.163 16 16 16h343c8.837 0 16-7.163 16-16V0H0Z" />
      <path
        fill="url(#illustration-sign-up-mobile_svg__b)"
        fillRule="nonzero"
        d="M0 0v268c0 8.837 7.163 16 16 16h343c8.837 0 16-7.163 16-16V0H0Z"
        mask="url(#illustration-sign-up-mobile_svg__c)"
      />
      <g mask="url(#illustration-sign-up-mobile_svg__c)">
        <g fillRule="nonzero" transform="translate(-16 87.784)">
          <use
            xlinkHref="#illustration-sign-up-mobile_svg__e"
            fill="#000"
            filter="url(#illustration-sign-up-mobile_svg__d)"
          />
          <use xlinkHref="#illustration-sign-up-mobile_svg__e" fill="#242742" />
        </g>
        <g transform="translate(-7.351 95.892)">
          <g fillRule="nonzero">
            <use
              xlinkHref="#illustration-sign-up-mobile_svg__g"
              fill="#000"
              filter="url(#illustration-sign-up-mobile_svg__f)"
            />
            <use
              xlinkHref="#illustration-sign-up-mobile_svg__g"
              fill="url(#illustration-sign-up-mobile_svg__h)"
            />
          </g>
          <mask id="illustration-sign-up-mobile_svg__l" fill="#fff">
            <use xlinkHref="#illustration-sign-up-mobile_svg__i" />
          </mask>
          <g fillRule="nonzero">
            <use
              xlinkHref="#illustration-sign-up-mobile_svg__i"
              fill="#000"
              filter="url(#illustration-sign-up-mobile_svg__j)"
            />
            <use
              xlinkHref="#illustration-sign-up-mobile_svg__i"
              fill="url(#illustration-sign-up-mobile_svg__h)"
          ...
          <circle
            ...
            cy={131.892}
            r={85.405}
            fill="url(#illustration-sign-up-mobile_svg__k)"
            fillRule="nonzero"
            mask="url(#illustration-sign-up-mobile_svg__l)"
          />
          <circle
            cx={73.754}
            cy={-18.678}
        ...
        <g fillRule="nonzero" transform="translate(157.513 35.892)">
          <use
            xlinkHref="#illustration-sign-up-mobile_svg__n"
            fill="#000"
            filter="url(#illustration-sign-up-mobile_svg__m)"
          />
          <use
            xlinkHref="#illustration-sign-up-mobile_svg__n"
            fill="url(#illustration-sign-up-mobile_svg__o)"
          />
          <path
            fill="url(#illustration-sign-up-mobile_svg__p)"
        ...
        <g transform="translate(220.757 24)">
          <path
            ...
            d="M0 2.162C0 .968.968 0 2.162 0h48.649c1.194 0 2.162.968 2.162 2.162v65.946a2.162 2.162 0 0 1-2.162 2.162H2.162A2.162 2.162 0 0 1 0 68.108V2.162Z"
          />
          <mask id="illustration-sign-up-mobile_svg__s" fill="#fff">
            <use xlinkHref="#illustration-sign-up-mobile_svg__q" />
          </mask>
          <use
            xlinkHref="#illustration-sign-up-mobile_svg__q"
            fill="#FFF"
            fillRule="nonzero"
          />
          <path
            fill="url(#illustration-sign-up-mobile_svg__r)"
            fillRule="nonzero"
            ...
            mask="url(#illustration-sign-up-mobile_svg__s)"
          />
          <path
            fill="#FFF"
            fillRule="nonzero"
          ...
          />
          <path
            fill="url(#illustration-sign-up-mobile_svg__t)"
...
const ForwardRef = forwardRef(SvgIllustrationSignUpMobile);
