...
const SvgIllustrationSignUpDesktop = (
  ...
  >
    <defs>
      <linearGradient
        id="illustration-sign-up-desktop_svg__b"
        x1="72.75%"
        x2="27.25%"
        y1="0%"
        y2="100%"
      ...
      <linearGradient
        id="illustration-sign-up-desktop_svg__h"
        x1="22.319%"
        x2="99.127%"
        y1="28.497%"
        y2="70.858%"
      ...
      <linearGradient
        id="illustration-sign-up-desktop_svg__k"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <linearGradient
        id="illustration-sign-up-desktop_svg__o"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <linearGradient
        id="illustration-sign-up-desktop_svg__p"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <linearGradient
        id="illustration-sign-up-desktop_svg__r"
        x1="97.791%"
        x2="7.729%"
        y1="26.944%"
        y2="71.879%"
      ...
      <linearGradient
        id="illustration-sign-up-desktop_svg__t"
        x1="50%"
        x2="50%"
        y1="0%"
        y2="100%"
      ...
      <filter
        id="illustration-sign-up-desktop_svg__f"
        width="129.9%"
        height="146.3%"
        x="-15%"
        y="-13.9%"
      ...
      <filter
        id="illustration-sign-up-desktop_svg__j"
        width="129.9%"
        height="146.3%"
        x="-15%"
        y="-13.9%"
      ...
      <filter
        id="illustration-sign-up-desktop_svg__m"
        width="127.7%"
        height="147.8%"
        x="-13.9%"
        y="-14.3%"
      ...
      <rect
        id="illustration-sign-up-desktop_svg__a"
        width={400}
        height={593}
        x={0}
        y={0}
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="illustration-sign-up-desktop_svg__c" fill="#fff">
        <use xlinkHref="#illustration-sign-up-desktop_svg__a" />
      </mask>
      <rect width={400} height={593} rx={16} />
      <path
        fill="url(#illustration-sign-up-desktop_svg__b)"
        fillRule="nonzero"
        d="M0 0h400v593H0z"
        mask="url(#illustration-sign-up-desktop_svg__c)"
      />
      <g mask="url(#illustration-sign-up-desktop_svg__c)">
        <g fillRule="nonzero" transform="translate(-192 211)">
          <use
            xlinkHref="#illustration-sign-up-desktop_svg__e"
            fill="#000"
            filter="url(#illustration-sign-up-desktop_svg__d)"
          />
          <use
            xlinkHref="#illustration-sign-up-desktop_svg__e"
            fill="#242742"
        ...
        <g transform="translate(-176 226)">
          <g fillRule="nonzero">
            <use
              xlinkHref="#illustration-sign-up-desktop_svg__g"
              fill="#000"
              filter="url(#illustration-sign-up-desktop_svg__f)"
            />
            <use
              xlinkHref="#illustration-sign-up-desktop_svg__g"
              fill="url(#illustration-sign-up-desktop_svg__h)"
            />
          </g>
          <mask id="illustration-sign-up-desktop_svg__l" fill="#fff">
            <use xlinkHref="#illustration-sign-up-desktop_svg__i" />
          </mask>
          <g fillRule="nonzero">
            <use
              xlinkHref="#illustration-sign-up-desktop_svg__i"
              fill="#000"
              filter="url(#illustration-sign-up-desktop_svg__j)"
            />
            <use
              xlinkHref="#illustration-sign-up-desktop_svg__i"
              fill="url(#illustration-sign-up-desktop_svg__h)"
          ...
          <circle
            ...
            cy={244}
            r={158}
            fill="url(#illustration-sign-up-desktop_svg__k)"
            fillRule="nonzero"
            mask="url(#illustration-sign-up-desktop_svg__l)"
          />
          <circle
            cx={136.446}
            cy={-34.554}
        ...
        <g fillRule="nonzero" transform="translate(129 115)">
          <use
            xlinkHref="#illustration-sign-up-desktop_svg__n"
            fill="#000"
            filter="url(#illustration-sign-up-desktop_svg__m)"
          />
          <use
            xlinkHref="#illustration-sign-up-desktop_svg__n"
            fill="url(#illustration-sign-up-desktop_svg__o)"
          />
          <path
            fill="url(#illustration-sign-up-desktop_svg__p)"
        ...
        <g transform="translate(246 93)">
          <path
            ...
            d="M0 4a4 4 0 0 1 4-4h90a4 4 0 0 1 4 4v122a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V4Z"
          />
          <mask id="illustration-sign-up-desktop_svg__s" fill="#fff">
            <use xlinkHref="#illustration-sign-up-desktop_svg__q" />
          </mask>
          <use
            xlinkHref="#illustration-sign-up-desktop_svg__q"
            fill="#FFF"
            fillRule="nonzero"
          />
          <path
            fill="url(#illustration-sign-up-desktop_svg__r)"
            fillRule="nonzero"
            ...
            mask="url(#illustration-sign-up-desktop_svg__s)"
          />
          <path
            fill="#FFF"
            fillRule="nonzero"
          ...
          />
          <path
            fill="url(#illustration-sign-up-desktop_svg__t)"
...
const ForwardRef = forwardRef(SvgIllustrationSignUpDesktop);
